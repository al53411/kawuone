    ...
    <div class="flex h-screen overflow-hidden relative">
        ...
        <div id="sidebar"
            ...
            <div class="h-16 flex items-center justify-between bg-slate-900 px-6 border-b border-slate-800 shrink-0">
                <div class="flex items-center space-x-2">
                    ...
                    <span class="text-white font-bold text-lg">{{ $profilSekolah->nama_sekolah ?? 'SDN KAWU 1' }}</span>
                </div>
            ...
            <div class="flex-1 overflow-y-auto px-4 py-6 space-y-1.5">
                ...
                <div class="space-y-1">
                    <button onclick="toggleDropdown('dropdown-akademik', 'arrow-akademik')"
                        ...
                        <div class="flex items-center space-x-3">
                            <i class="fa-solid fa-server text-slate-400 group-hover:text-blue-500 transition"></i>
                            <span class="font-medium text-sm">Master Data</span>
                        </div>
                        <i id="arrow-akademik"
                            class="fa-solid fa-chevron-down text-xs text-slate-500 group-hover:text-white transition-transform duration-200"></i>
                    </button>

                    <div id="dropdown-akademik" class="hidden pl-11 pr-2 py-1 space-y-1 bg-slate-900/40 rounded-lg">
                ...
                <div class="space-y-1">
                    <button onclick="toggleDropdown('dropdown-administrasi', 'arrow-administrasi')"
                        class="w-full flex items-center justify-between px-4 py-3 rounded-lg hover:bg-slate-800 hover:text-white transition group focus:outline-none">
                        <div class="flex items-center space-x-3">
                            <i class="fa-solid fa-folder-open text-slate-400 group-hover:text-blue-500 transition"></i>
                    ...
                    <div id="dropdown-administrasi" class="hidden pl-11 pr-2 py-1 space-y-1 bg-slate-900/40 rounded-lg">
                ...
                <div class="space-y-1">
                    <button onclick="toggleDropdown('dropdown-surat', 'arrow-surat')"
                        class="w-full flex items-center justify-between px-4 py-3 rounded-lg hover:bg-slate-800 hover:text-white transition group focus:outline-none">
                        <div class="flex items-center space-x-3">
                            <i class="fa-solid fa-envelope text-slate-400 group-hover:text-blue-500 transition"></i>
                    ...
                    <div id="dropdown-surat" class="hidden pl-11 pr-2 py-1 space-y-1 bg-slate-900/40 rounded-lg">
                        <a href="#"
                            class="block py-2 px-3 text-sm rounded-md text-slate-400 hover:text-white transition">
            ...
            <!-- Footer Sidebar (Tombol Logout Ditempatkan di Sini) -->
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 z-10 shrink-0">
                ...
                <div class="flex items-center space-x-3">
                    <span
                        class="text-sm font-semibold text-slate-700">{{ Auth::user()->name ?? 'Administrator' }}</span>
                    <div
