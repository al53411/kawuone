...
<div class="w-full bg-white rounded-xl shadow-sm border p-4 sm:p-6 md:p-8">
    ...
    <div class="mb-6 sm:mb-8 border-b pb-4">
        <h1 class="text-xl sm:text-2xl font-bold text-gray-900">Edit Data Guru</h1>
        <p class="text-xs sm:text-sm text-gray-500 mt-1">Perbarui data guru berdasarkan dokumen resmi Dukcapil, BKN, dan
            Dapodik.</p>
    </div>

    <form action="{{ route('admin.guru.update', $guru->id) }}" method="POST" class="space-y-6 sm:space-y-8">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 bg-gray-50/50 p-4 sm:p-6 rounded-xl border">
                ...
                <div>
                    ...
                    <input type="text" name="nik" value="{{ old('nik', $guru->nik) }}" maxlength="16"
                ...
                <div>
                    ...
                    <input type="text" name="nama_ibu_kandung"
                        value="{{ old('nama_ibu_kandung', $guru->nama_ibu_kandung) }}"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 bg-gray-50/50 p-4 sm:p-6 rounded-xl border">
                ...
                <div>
                    <label class="block text-xs sm:text-sm font-semibold text-gray-700 mb-1.5 sm:mb-2">NIP (18
                        Digit)</label>
                    <input type="text" name="nip" value="{{ old('nip', $guru->nip) }}" maxlength="18"
                ...
                <div>
                    ...
                    <select name="status_kepegawaian"
                        ...
                        <option value="GTY"
                            {{ old('status_kepegawaian', $guru->status_kepegawaian) == 'GTY' ? 'selected' : '' }}>GTY
                ...
                <div>
                    <label class="block text-xs sm:text-sm font-semibold text-gray-700 mb-1.5 sm:mb-2">Golongan /
                        Ruang</label>
                    <input type="text" name="golongan" value="{{ old('golongan', $guru->golongan) }}"
                ...
                <div>
                    <label class="block text-xs sm:text-sm font-semibold text-gray-700 mb-1.5 sm:mb-2">TMT SK
                        Berjalan</label>
                    <input type="date" name="tmt_sk" value="{{ old('tmt_sk', $guru->tmt_sk) }}"
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-2 sm:gap-3">
                        <div>
                            <input type="number" name="mkg_tahun" value="{{ old('mkg_tahun', $guru->mkg_tahun) }}"
                                min="0" placeholder="Tahun"
                        ...
                        <div>
                            <input type="number" name="mkg_bulan" value="{{ old('mkg_bulan', $guru->mkg_bulan) }}"
                                min="0" max="11" placeholder="Bulan"
                                class="w-full px-3 py-2 sm:py-2.5 rounded-lg border focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-xs sm:text-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 bg-gray-50/50 p-4 sm:p-6 rounded-xl border">
                ...
                <div>
                    ...
                    <select name="pendidikan_terakhir"
                        ...
                        required>
                        <option value="S-1"
                            {{ old('pendidikan_terakhir', $guru->pendidikan_terakhir) == 'S-1' ? 'selected' : '' }}>S-1
                            / D-4</option>
                        <option value="S-2"
                            {{ old('pendidikan_terakhir', $guru->pendidikan_terakhir) == 'S-2' ? 'selected' : '' }}>S-2
                        </option>
                        <option value="S-3"
                            {{ old('pendidikan_terakhir', $guru->pendidikan_terakhir) == 'S-3' ? 'selected' : '' }}>S-3
                        </option>
                        <option value="D-3"
                            {{ old('pendidikan_terakhir', $guru->pendidikan_terakhir) == 'D-3' ? 'selected' : '' }}>D-3
                        </option>
                    </select>
                ...
                <div>
                    <label class="block text-xs sm:text-sm font-semibold text-gray-700 mb-1.5 sm:mb-2">NUPTK (16
                        Digit)</label>
                    <input type="text" name="nuptk" value="{{ old('nuptk', $guru->nuptk) }}" maxlength="16"
                ...
                <div>
                    ...
                    <input type="text" name="no_serdik" value="{{ old('no_serdik', $guru->no_serdik) }}"
                        placeholder="Nomor Serdik"
                ...
                <div>
                    <label class="block text-xs sm:text-sm font-semibold text-gray-700 mb-1.5 sm:mb-2">NRG (Nomor
                        Register Guru)</label>
                    <input type="text" name="nrg" value="{{ old('nrg', $guru->nrg) }}" placeholder="Nomor Register Guru"
